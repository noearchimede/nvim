return {
    ...
    keys = {
        { '<leader>gdi', '<cmd>DiffviewOpen<cr>', desc = "Diffview: compare against index" },
        { '<leader>gdc', '<cmd>DiffviewOpen<cr>', desc = "Diffview: compare against last commit" },
        { '<leader>gdd', '<cmd>DiffviewOpen ',    desc = "Diffview: enter command" },
    },
        ...
        require("diffview").setup({
            ...
            keymaps = {
                ...
                file_panel = {
                    ...
                    { "n", "<C-e>f",        actions.focus_files,                   { desc = "Bring focus to the file panel" } },
                    { "n", "<C-e>t",        actions.toggle_files,                  { desc = "Toggle the file panel" } },
